...
export default function Main({step, nextStep,previousStep, goToStep}) {
  ...
  return (
    <div className="flex flex-col py-7 px-6 md:w-2/3 justify-between bg-white  mt-[-50px] m-8 md:mt-0 md:rounded-r-lg rounded-lg">
        {/*Form / conditional steps rendered*/}
        {CurrentStep()}

        {/*Navigation buttons to move from one step to another*/}

        <div className="navigationContainer flex flex-row justify-end w-full mt-10">
            ...
            {step === 3 && isSummaryConfirmed ? null : (
                ...
                className='rounded-md bg-third py-3 px-6 text-white place-self-end disabled:bg-third/50'
